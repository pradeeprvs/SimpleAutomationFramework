...
public class BaseClass {
	...
	public String getScreenshot(WebDriver driver, String Screenshotname) {
		...
		String destination = System.getProperty("user.dir")+"\\eclipse-workspace\\jenkins\\jobs\\SimpleFramework\\htmlreports\\HTML_20Report\\" + Screenshotname + dateName + ".png";
		String tempDestination="\\Screenshots\\"+Screenshotname + dateName + ".png";
